    ...
    <>
      ...
      <FullColumn height="h-[400px]">
        {appLists && appLists.length > 0 ? (
          <>
            <p className="p-4 font-light">App Lists</p>
              ...
              {appLists.map((list: AppListEntry, i) => {
                return (
                  <div
                    ...
                    className={`
                      m-1 flex w-full cursor-pointer flex-row content-center
                      justify-between border-b-2 border-fuchsia-500 p-2 align-middle  hover:bg-slate-700 ${
